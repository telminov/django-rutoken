...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Certificate.pem'
        db.alter_column('rutoken_certificate', 'pem', self.gf('django.db.models.fields.files.FileField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Certificate.pem'
        db.alter_column('rutoken_certificate', 'pem', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'rutoken.certificaterequest': {
            ...
            'pem': ('django.db.models.fields.TextField', [], {}),
