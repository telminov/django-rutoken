...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('rutoken_certificaterequest', (
            ...
            ('common_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ...
            ('pem', self.gf('django.db.models.fields.TextField')()),
        ...
        db.create_table('rutoken_certificate', (
            ('serial_number', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
