...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Certificate.id'
        db.add_column('rutoken_certificate', 'id',
                      self.gf('django.db.models.fields.AutoField')(primary_key=True),
                      keep_default=False)


        # Changing field 'Certificate.serial_number'
        db.alter_column('rutoken_certificate', 'serial_number', self.gf('django.db.models.fields.IntegerField')(unique=True))

    def backwards(self, orm):
        # Deleting field 'Certificate.id'
        db.delete_column('rutoken_certificate', 'id')


        # Changing field 'Certificate.serial_number'
        db.alter_column('rutoken_certificate', 'serial_number', self.gf('django.db.models.fields.AutoField')(primary_key=True))
