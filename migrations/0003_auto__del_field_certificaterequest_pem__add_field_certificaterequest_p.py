...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename field 'CertificateRequest.pem'
        db.rename_column('rutoken_certificaterequest', 'pem', 'pem_text')

        # Adding field 'CertificateRequest.pem_file'
        db.add_column('rutoken_certificaterequest', 'pem_file',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CertificateRequest.pem_text'
        db.rename_column('rutoken_certificaterequest', 'pem_text', 'pem')

        # Deleting field 'CertificateRequest.pem_file'
        db.delete_column('rutoken_certificaterequest', 'pem_file')
    ...
    models = {
        ...
        'rutoken.certificaterequest': {
            ...
            'common_name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
