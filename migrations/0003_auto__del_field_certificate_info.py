...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Certificate.info'
        db.delete_column('rutoken_certificate', 'info')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Certificate.info'
        raise RuntimeError("Cannot reverse this migration. 'Certificate.info' and its values cannot be restored.")
